...
function modifier_meat_hook:OnCreated( kv )
	if IsServer() then
...
function modifier_meat_hook:UpdateHorizontalMotion( me, dt )
	if IsServer() then
...
--------------------------------------------------------------------------------
function modifier_meat_hook:OnHorizontalMotionInterrupted()
	if IsServer() then
		if self:GetAbility().hVictim ~= nil then
