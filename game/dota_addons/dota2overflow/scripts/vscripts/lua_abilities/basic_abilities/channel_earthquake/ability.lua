...
LinkLuaModifier( "generic_lua_stun", "lua_abilities/moddota_help/generic_stun.lua", LUA_MODIFIER_MOTION_NONE )
 ...
 function channel_earthquake:Explosion(vPos)
	...
	EmitSoundOnLocationWithCaster(self.point, "Hero_EarthShaker.Gravelmaw.Cast", hCaster )
		...
		local enemies = FindUnitsInRadius( hCaster:GetTeamNumber(), vPos, nil, aoe, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_MECHANICAL, 0, 0, false )
		if #enemies > 0 then
