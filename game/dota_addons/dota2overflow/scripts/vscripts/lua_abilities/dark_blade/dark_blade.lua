dark_blade = class({})
LinkLuaModifier( "modifier_dark_blade", "lua_abilities/dark_blade/modifier_dark_blade.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_dark_blade_fade", "lua_abilities/dark_blade/modifier_dark_blade_fade.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_dark_blade_curse", "lua_abilities/dark_blade/modifier_dark_blade_curse.lua", LUA_MODIFIER_MOTION_NONE )
