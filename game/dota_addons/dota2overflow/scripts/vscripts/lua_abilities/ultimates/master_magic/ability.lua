if master_magic == nil then
	master_magic = class({})
end

LinkLuaModifier( "master_magic_mod", "lua_abilities/ultimates/master_magic/modifier.lua", LUA_MODIFIER_MOTION_NONE )

function master_magic:GetBehavior() 
	local behav = DOTA_ABILITY_BEHAVIOR_NO_TARGET
	return behav
end

function master_magic:OnSpellStart()
