if item_maelstrom_ovf_orb == nil then
	item_maelstrom_ovf_orb = class({})
end

function item_maelstrom_ovf_orb:OnCreated( kv )	
	if IsServer() then
...
function item_maelstrom_ovf_orb:IsHidden()
	return true
end


function item_maelstrom_ovf_orb:OnDestroy()
	if IsServer() then
...
function item_maelstrom_ovf_orb:DamageParent()
	if IsServer() then
...
function item_maelstrom_ovf_orb:HasProtection(hTarget)
	if IsServer() then
		local hAbility = self:GetAbility()
...
function item_maelstrom_ovf_orb:IsPurgable()
	return false
end

function item_maelstrom_ovf_orb:GetAttributes() 
